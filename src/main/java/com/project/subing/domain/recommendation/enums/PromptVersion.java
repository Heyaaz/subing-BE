...
public enum PromptVersion {
    ...
    V1("기본 프롬프트", """
        ...
        [필수] 한글 띄어쓰기 규칙:
        모든 한글 값에 반드시 자연스러운 띄어쓰기를 적용하세요.
        잘못된 예: "클라우드저장소와파일공유가매우유용하며업무효율성을높일수있습니다"
        올바른 예: "클라우드 저장소와 파일 공유가 매우 유용하며 업무 효율성을 높일 수 있습니다"
        잘못된 예: "다양한콘텐츠를합리적인가격에즐길수있어요"
        올바른 예: "다양한 콘텐츠를 합리적인 가격에 즐길 수 있어요"
